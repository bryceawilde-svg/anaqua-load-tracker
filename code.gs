...
function matchDeliveredTicket(payload) {
  ...
  const prompt = 'You are reading a DELIVERED/SCALE TICKET from a grain elevator or buyer in Texas. ' +
    ...
    'For gross_weight, tare_weight, and net_weight: these are weights in pounds — always large whole numbers with no decimal point. Gross is typically 55,000–85,000, tare 25,000–35,000, net 30,000–65,000. They are printed with a comma thousands separator (e.g. "74,780" or "74780"). The comma is NOT a decimal point — return "74780", never "74.78". SELF-CHECK: if any weight value you read is less than 1,000 or contains a decimal point, you have misread it — re-examine the ticket and correct it before returning. ' +
